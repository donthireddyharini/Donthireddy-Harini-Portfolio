...
function addSectionTitle(title, linkText = null) {
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.setTextColor(0, 0, 0);
...
// Project 1: DSA Legends
doc.setFont("helvetica", "bold");
doc.setFontSize(9.5);
doc.text("DSA Legends – DSA Learning Game", marginX, cursorY);
let p1w = doc.getTextWidth("DSA Legends – DSA Learning Game");
doc.setFont("helvetica", "normal");
...
let p2w = doc.getTextWidth("LitMind – AI-Powered Literature Tutor");
doc.setFont("helvetica", "normal");
...
doc.text("Diploma (Computer Science and Engineering) — CGPA: 9.27", marginX, cursorY);
...
const outputPath = path.join(publicDir, "Harini_Donthireddy_Resume.pdf");
